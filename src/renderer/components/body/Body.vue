    ...
    <v-container grid-list-xs pa-0>
        <v-layout column>
            ...
            <v-flex>
                <v-fade-transition>
                    <div class="text-xs-center" v-show="getCurrentFeature['en'] === ''">
                        <div class="display-2 pb-4 font-weight-light text-xs-center">HWP(5.0) Format Library</div>
                        <p class="title orange--text font-weight-light">"본 라이브러리는 한글과 컴퓨터의 HWP 문서 파일 (.hwp) 공개 문서를 참고하여 개발하였습니다."</p>
                    </div>
                </v-fade-transition>
                <div class="text-xs-center py-5" v-if="getCurrentFeature['en'] !== ''">
                    <div class="display-3 orange--text">
            ...
            <v-flex xs12 v-if="getCurrentFeature['en'] === ''">
                <file-control-pane></file-control-pane>
            </v-flex>
...
<script>
    ...
    import FileAttachFeature from "./feature/FileAttachFeature";
    import FilenameFeature from "./feature/FilenameFeature";
    import ImageFeature from "./feature/ImageFeature";
    import TableFeature from "./feature/TableFeature";
    import TextFeature from "./feature/TextFeature";
    ...
    import FileControlPane from "./unit/FileControlPane";
    import SearchFeature from "./feature/SearchFeature";
    ...
    export default {
        ...
        components: {
            ...
            FileTable,
            TextFeature,
            TableFeature, ImageFeature, FilenameFeature, FileAttachFeature, FileCard},
        data: () => ({
            selectFile: '선택된 파일',
            featureComponent: '',
            hideFileTable: true,
