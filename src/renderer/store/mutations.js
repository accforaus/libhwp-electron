...
export default {
    ...
    [types.SET_CURRENT_FEATURE](state, { payload }) {
        ...
        switch (payload) {
            ...
            case 'FileAttachFeature':
                ...
                break
            case 'SearchFeature':
                state.selectedFeature.kr = '폴더 내 문서 문자 검색'
                state.selectedFeature.sub = 'Document File Search'
                break
            default:
    ...
    [types.SET_SEARCHED_TEXT](state, { payload }) {
        state.textSearch.fileObject = payload
    },

    [types.SET_IS_SEARCH](state, { payload }) {
        state.textSearch.loading = payload
    }
}
